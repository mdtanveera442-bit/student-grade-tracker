...
/**
 * A modern text field with rounded corners, focus glow ring, and balanced padding.
 */
public class RealisticTextField extends JTextField implements FocusListener {

    private final int arc;
    private String placeholder;
    private boolean isFocused = false;

    public RealisticTextField(int columns) {
        this("", columns, 8);
    }

    public RealisticTextField(String placeholder, int columns) {
        this(placeholder, columns, 8);
    }

    public RealisticTextField(String placeholder, int columns, int arc) {
        super(columns);
    ...
    protected void paintComponent(Graphics g) {
        ...
        if ((getText() == null || getText().isEmpty()) && placeholder != null && !isFocused) {
